  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-secondary border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="programmea.jsp" class="list-group-item list-group-item-action bg-secondary text-light">PROGRAMME</a>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <form class="form-horizontal" role="form" action="">
      <div class="form-group">
              ...
              <div class="col-sm-12">
                  <input type="text" class="form-control" name="CPassword" placeholder="currentpassword" required="this" />
              </div>
            </div>
              <div class="form-group">
              <div class="col-sm-12">
                  <input type="text" class="form-control" name="IPassword" placeholder="New Password" required="this" />
              </div>
            </div>
          
            <div class="form-group">
              <div class="col-sm-12">
                  <input type="text" class="form-control" name="CPassword" placeholder="Change Password" required="this" />
              </div>
            </div>
